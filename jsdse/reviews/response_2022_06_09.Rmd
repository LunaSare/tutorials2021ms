...
We agree. We have cited this work at the end of the first paragraph of the Conlcusion section: "These approaches not only teach reproducibility, but also make the teaching process itself reproducible (Dogucu & Cetinkaya-Rundel 2022). 
...
Thank you! We addressed that on the first paragraph of the Conclusion section.
...
Thank you, the point that you raise is very important. Associate Editor highlighted your comment and points out that this can be addressed by providing information on package version used. In general, old package versions remain accessible, and persist in time, so they can be used to reproduce an analysis, even long time after a function had been deprecated. 
...
We now discuss this barrier on the first paragraph of the Conclusion section.
