...
In this paper, we argue that accessibility of research products is a key aspect for
improving reproducibility rates.
While accessibility typically addresses differences in abilities (visual, hearing, cognitive).


across individuals, we particularly address barriers to accessibility at the
